    ...
    <div className="flex-1 h-screen overflow-y-auto bg-gray-50">
      ...
      <div className="p-8 border-b bg-white">
        <div className="flex items-center gap-6">
          ...
          {/* USER INFO */}
          <div>
            <h1 className="text-4xl font-bold">{authUser?.fullName}</h1>
            <p className="text-gray-500 mt-2">{authUser?.email}</p>
            <p className="text-sm text-gray-400 mt-2">Member of Konvo</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-8">
        ...
        {/* EMPTY STATE */}
        {friends.length === 0 ? (
          <div className="text-center py-20 text-gray-500">No friends yet</div>
        ) : (
          /* FRIEND GRID */
